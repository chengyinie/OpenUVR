...
2. Once access is granted to the Epic Games repositories, download the repository at https://github.com/EpicGames/UnrealTournament, checkout the latest release commit and follow the instructions given at https://wiki.unrealengine.com/Building_On_Linux to compile it for Linux.
